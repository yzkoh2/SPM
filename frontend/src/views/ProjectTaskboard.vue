        ...
        <div class="flex justify-between h-16">
          <div class="flex">
            ...
            <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
              <router-link to="/" 
                           :class="[isActiveRoute('/') && !isActiveRoute('/projects') ? 'border-indigo-500 text-gray-900' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700', 'inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium']">
                My Tasks
              </router-link>
              <router-link to="/projects" 
                           :class="[isActiveRoute('/projects') ? 'border-indigo-500 text-gray-900' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700', 'inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium']">
                Projects
              </router-link>
            </div>
          </div>
          <div class="flex items-center">
            <span class="text-sm text-gray-700 mr-4">{{ authStore.currentUser?.username || 'User' }}</span>
            <button @click="authStore.logout(); router.push('/login')" 
                    class="bg-white px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-gray-900">
              Logout
            </button>
          </div>
        </div>

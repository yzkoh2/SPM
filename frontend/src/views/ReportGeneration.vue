  ...
  <div class="min-h-screen bg-gray-50">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="mb-8">
        ...
        <p class="text-sm text-gray-600 mt-1">Create individual or project task performance reports</p>
      </div>
        ...
        <form @submit.prevent="generateReport">
            ...
            <div v-else>
              <div class="bg-blue-50 border border-blue-200 rounded-md p-3">
                <p class="text-sm text-blue-700">
                  <span class="font-medium">Generating report for:</span> {{ currentUser?.name || 'Current User' }}
                </p>
              </div>
            </div>
          </div>
          ...
          <div v-if="reportType === 'project'" class="space-y-6">
            ...
            <div>
              ...
              <p class="text-xs text-gray-500 mt-1">
                Select a project you own or collaborate on
              </p>
            </div>
          </div>
          ...
          <div class="mt-6 space-y-4">
            ...
            <!-- Custom Date Range -->
            <div v-if="timeframe === 'custom'" class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4 p-4 bg-gray-50 rounded-md">
              <div>
        ...
        <div class="flex">
          ...
          <div class="text-sm text-blue-700">
            ...
            <ul class="list-disc list-inside space-y-1 text-xs">
              ...
              <li>Reports include completion rates, average completion time, and velocity metrics</li>
            </ul>
          </div>
        </div>
      </div>
...
const canSelectOtherUsers = computed(() => {
  return currentUser.value && (currentUser.value.role === 'Manager' || currentUser.value.role === 'Director')
})
...
const generateReport = async () => {
  ...
  try {
    ...
    const fileName = reportType.value === 'individual' 

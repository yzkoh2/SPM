  ...
  <div class="min-h-screen bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div v-if="error" class="bg-red-50 border border-red-200 rounded-md p-6 mb-6">
        ...
        <div class="mt-4">
          <button @click="loadDepartmentTasks"
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-6">
          <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
            <div class="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-4">
              ...
              <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Filter by Department Member</label>
                <select v-model="filters.departmentMember" @change="applyFilters"
